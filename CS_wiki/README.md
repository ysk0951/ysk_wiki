...
## Chapter 01
> 소프트웨어 생명주기의 정의
* 소프트웨어를 개발하기 위해 설계, 운용, 유지보수등의 과정을 단계별로 나눈것
> 소프트웨어 개발방법론의 4가지 정의
* 폭포수, 프로토타입, 나선형, 애자일
> 스크럼 프로세스 5단계
...
* 단순, 의사소통, 용기, 존중, 피드백
> XP 실천방법 6가지
* Pair Programming, Collective Ownership, TDD
* Whole Team, Continuous Intergration, Refactoring, Small Release
> 개발환경 파악
* 가용성, 성능, 기술지원, 구축비용
* 주변기기 / 상호호완성
> 요구사항 개발 프로세스 4단계
* 도출 -> 분석 -> 명세 -> 확인
> 비기능요구사항, 기능요구사항, 사용자요구사항, 시스템요구사항
> 정형요구사항 명세, 비정형 요구사항 명세
* 수학 / 자연어
> 분석단계의 구조적 분석방법중 DFD 기본구성 4가지
* Process, DataFlow, Data Stroe, Terminator
...
* 기간 예측이 어려운경우 일정은 PERT, 작업 소요시간이 있을시에는 CPM
* 임계는 최대값을 선정
