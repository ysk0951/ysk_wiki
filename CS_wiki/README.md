...
* ~ (보수)
* 음수는 보수의 +1
* 음수의 shift연산은  왼쪽 시프트는 0, 오른쪽 시프트는 1이 들어온다
> 진수표현
* 8진수 - 앞에 0
* 16진수 - 뒤에 0x
> 헷갈리는 연산
...
> IPv6 개념
* 16bit씩 8부분, 총 128비트로써 16진수로 표현하고 콜론으로 구분
...
> 테스트 기반에 따른 테스트
* https://blog.naver.com/PostView.naver?blogId=melong826&logNo=222201924884
...
* 비인가 시스템 자동으로 검출
* 내부 PC의 소프트웨어 사용현황을 관리
* 내부 PC의 맥주소를 관시시스템에 등록
