...
프로그래밍 언어 주요개념
----
> 외부동작을 바꾸지 않으면서 내부구조를 개선하는것
* 리팩토링
> 변수명, 함수명앞에 데이터 타입의 정보를 접두어로 지정하는 규칙
* 헝가리안표기법
...
* 브로드 데이터
> 데이터 마이닝
* 저장된 데이터 집합에서 하용자 요구에 따라 유용한 데이터를 발견하기 위한 기법으로 의사결정에 호라용하는 기술
> 복구 목표시간
* 업무 중단 시점부터 업무가 정상적으로 복구될대까지의 시간
...
> ROLLBACK
* 트랜잭션 처리가 비정상적으로 종료되었을떄 연산을 취소하는 행위
* ROLLBACK TO S2;
